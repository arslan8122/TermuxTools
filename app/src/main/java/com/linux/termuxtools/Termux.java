...
public class Termux extends AppCompatActivity {
    ListView lv;
...
//                System.out.println(data+" Name: ");
                ...
                arrayList.add(data);
                ListAdapter adapter = new SimpleAdapter(Termux.this,arrayList,R.layout.listview_layout
                ...
                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l ) {
                        ...
                        Intent intent = new Intent(Termux.this, Detail.class);
                        System.out.println("notout"+arrayList.get(i).get("name"));

                        AdRequest adRequest = new AdRequest.Builder().build();
//ca-app-pub-2727672331058815/5825501152 production
                        //ca-app-pub-3940256099942544/1033173712 test
                        InterstitialAd.load(view.getContext(),AdsId.ADMOB_AD_UNIT_ID_Interstitial, adRequest, //test
//                                InterstitialAd.load(view.getContext(),"ca-app-pub-2727672331058815/5825501152", adRequest, //prod
                        ...
                        if(strData % 3 == 0) {
                            if (mInterstitialAd != null) {
                                mInterstitialAd.show(Termux.this);
    ...
    public String readJSONFromAsset() {
        String json = null;
        try {
            InputStream is = getAssets().open("wow.json");
    ...
    public void onBackPressed() {
        System.out.println("wowwwTermux");
        Intent intent=new Intent(Termux.this,MainActivity.class);
...
//            refresh.setEnabled(true);
                        ...
                        if (Termux.this.nativeAd != null) {
                            Termux.this.nativeAd.destroy();
                        }
                        Termux.this.nativeAd = nativeAd;
                        LinearLayout frameLayout = findViewById(R.id.ad);
                        NativeAdView adView =
