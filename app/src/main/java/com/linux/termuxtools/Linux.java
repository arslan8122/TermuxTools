...
public class Linux extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshAd();
//        AdLoader adLoader = new AdLoader.Builder(this, AdsId.ADMOB_AD_UNIT_ID_Native)
...
//            refresh.setEnabled(true);
                        ...
                        if (Linux.this.nativeAd != null) {
                            Linux.this.nativeAd.destroy();
                        }
                        Linux.this.nativeAd = nativeAd;
